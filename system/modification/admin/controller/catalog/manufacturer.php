...
class ControllerCatalogManufacturer extends Controller {
    ...
    $data['seo_url_generator_status'] = $this->config->get('seo_url_generator_status');
		...
		$this->load->language('module/seo_url_generator');
		...
		if (isset($this->request->get['manufacturer_id'])) {
			if (isset($this->request->post['seo_url_generator_redirects'])) {
				...
				$data['redirects'] = $this->model_module_seo_url_generator->getRedirects('manufacturer_id', $this->request->get['manufacturer_id']);
			}
		} else {
