...
$_['text_about'] = '<p>Этот модуль, пожалуй, самый "замороченный" модуль на тему SEO URL в OpenCart.</p>
				<p>В отличие от многих похожих решений, <b>SEO URL Generator FREE by Serge Tkach</b> позволяет Вам вписывать редиректы для товаров, категорий, производителей. Ведь такое бывает, что товару или категории необходимо присвоить другую ссылку. Во многих других CMS подобный функционал есть из коробки. С помощью данного модуля такое возможно и в OpenCart.</p>
				<p>Также модуль может "проследить" за тем, чтобы SEO URL сами менялись в случае, когда Вы меняете название товара. При этом старый ЧПУ (который уже может находиться в результатах поиска), автоматически будет перенаправлять на новый ЧПУ с редиректом 301.</p>';
